...
public class BaseConfiguration {
    ...
    public BaseConfiguration()
    {
        try {
            prop=new Properties();
            FileInputStream ip = new FileInputStream("./src/util/config.properties");
            prop.load(ip);
    ...
    public static void initializationMethod()
    {
        ...
        if(browser.equalsIgnoreCase("chrome"))
        {
            ...
            System.setProperty("webdriver.chrome.driver", "C://TEMP//Programs//Softwares//chromedriver79//chromedriver.exe");
